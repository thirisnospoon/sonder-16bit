...
Числа этого замера зависят от машины сильнее прочих: он упирается в
базу, а не в линию. Прогон, показанный на графике, шёл одновременно с
фаззером — заявленный ранее потолок в пятьсот событий в секунду
измерялся на свободной машине.
